...
def generate_certificate(data, output_dir):
    ...
    background_image_base64 = encode_image_to_base64(r"C:\Users\sadiq\OneDrive\Desktop\samsung\rnsit_sam_py\day6\Certificate_Generator(White)\Certificate_Generator(White)\assests\background.png")
    org_logo_base64 = encode_image_to_base64(r"C:\Users\sadiq\OneDrive\Desktop\samsung\rnsit_sam_py\day6\Certificate_Generator(White)\Certificate_Generator(White)\assests\logo.png")
    signature_image_base64 = encode_image_to_base64(r"C:\Users\sadiq\OneDrive\Desktop\samsung\rnsit_sam_py\day6\Certificate_Generator(White)\Certificate_Generator(White)\assests\sign.png")
...
if __name__ == "__main__":
    input_csv = r"C:\Users\sadiq\OneDrive\Desktop\samsung\rnsit_sam_py\day6\Certificate_Generator(White)\Certificate_Generator(White)\assests\data.csv"  # Path to CSV file
    output_directory = r"C:\Users\sadiq\OneDrive\Desktop\samsung\rnsit_sam_py\day6\Certificate_Generator(White)\Certificate_Generator(White)\html_certificates"  # Output directory
